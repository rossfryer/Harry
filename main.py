...
# SDD Project - Python PyGame Platformer/Shooter
...
pygame.display.set_caption('Shooter Platformer Project')
...
# Load Images
cursor = pygame.transform.scale(pygame.image.load('cursor.png'), (32, 32)).convert()
cursor.set_colorkey((255, 255, 255))

instruction_img = pygame.image.load('instructions.png').convert_alpha()
title_img = pygame.image.load('title_image.png').convert_alpha()
health_bar_img = pygame.image.load('health_bar.png').convert_alpha()
overlay_img = pygame.transform.scale(pygame.image.load('black_overlay.png').convert(), WINDOW_SIZE)
overlay_img.set_alpha(150)

grass = pygame.image.load('grass.png').convert()
dirt = pygame.image.load('dirt.png').convert()
middle_platform = pygame.image.load('platform_middle.png').convert_alpha()
left_edge_platform = pygame.image.load('platform_edge.png').convert_alpha()
right_edge_platform = pygame.transform.flip(pygame.image.load('platform_edge.png').convert_alpha(),
                                            True, False)
left_transition_dirt = pygame.image.load('transition_dirt.png').convert()
right_transition_dirt = pygame.transform.flip(pygame.image.load('transition_dirt.png').convert(),
                                              True, False)
left_transition_grass = pygame.image.load('transition_grass.png').convert()
right_transition_grass = pygame.transform.flip(pygame.image.load('transition_grass.png').convert(),
                                               True, False)
left_edge_dirt = pygame.image.load('edge_dirt.png').convert_alpha()
right_edge_dirt = pygame.transform.flip(pygame.image.load('edge_dirt.png').convert_alpha(), True,
                                        False)
left_edge_grass = pygame.image.load('edge_grass.png').convert_alpha()
right_edge_grass = pygame.transform.flip(pygame.image.load('edge_grass.png').convert_alpha(), True,
                                         False)
left_side_grass_transition = pygame.image.load('side_grass_transition.png').convert_alpha()
right_side_grass_transition = pygame.transform.flip(
    pygame.image.load('side_grass_transition.png').convert_alpha(), True, False)
left_bottom_corner_dirt = pygame.image.load('bottom_corner_dirt.png').convert_alpha()
right_bottom_corner_dirt = pygame.transform.flip(
    pygame.image.load('bottom_corner_dirt.png').convert_alpha(), True, False)
bottom_dirt = pygame.image.load('bottom_dirt.png').convert_alpha()
...
enemy_projectile_img = pygame.image.load('enemy_projectile.png').convert()
...
class Level():
    def __init__(self, map_name, player_pos, enemy_pos, die_height):
        ...
        self.path = '{}.txt'.format(self.map_name)
        self.timer = 0
...
while True:
    ...
    if main_menu:
        ...
        load_game_button = Button(560, 800, 800, 200, (75, 160, 173), "Load Game ({}/9)".format(len(get_saves())),
